...
const totalEntries = async () => {
    ...
    for (let index = 0; index < summaryEntriesDaily.length; index++) {
        ...
        await model.insertEntriesSummarydayli({
            validMicrosite: summaryEntriesDaily[index].valid_400 || 0,
            invalidMicrosite: summaryEntriesDaily[index].invalid_400 || 0,
            validWa1: summaryEntriesDaily[index].valid_301 || 0,
            invalidWa1: summaryEntriesDaily[index].invalid_301 || 0,
            validWa2: summaryEntriesDaily[index].valid_300 || 0,
            invalidWa2: summaryEntriesDaily[index].invalid_300 || 0,
            validWa3: summaryEntriesDaily[index].valid_302 || 0,
            invalidWa3: summaryEntriesDaily[index].invalid_302 || 0,
            valid: summaryEntriesDaily[index].valid || 0,
            invalid: summaryEntriesDaily[index].invalid || 0,
            total: summaryEntriesDaily[index].all || 0,
    ...
    for (let index = 0; index < summaryEntriesMonthly.length; index++) {
        await model.insertEntriesSummarydayli({
            validMicrosite: summaryEntriesMonthly[index].valid_400 || 0,
            invalidMicrosite: summaryEntriesMonthly[index].invalid_400 || 0,
            validWa1: summaryEntriesMonthly[index].valid_301 || 0,
            invalidWa1: summaryEntriesMonthly[index].invalid_301 || 0,
            validWa2: summaryEntriesMonthly[index].valid_300 || 0,
            invalidWa2: summaryEntriesMonthly[index].invalid_300 || 0,
            validWa3: summaryEntriesMonthly[index].valid_302 || 0,
            invalidWa3: summaryEntriesMonthly[index].invalid_302 || 0,
            valid: summaryEntriesMonthly[index].valid || 0,
            invalid: summaryEntriesMonthly[index].invalid || 0,
            total: summaryEntriesMonthly[index].all || 0,
    ...
    for (let index = 0; index < summaryEntriesWeekly.length; index++) {
        await model.insertEntriesSummarydayli({
            validMicrosite: summaryEntriesWeekly[index].valid_400 || 0,
            invalidMicrosite: summaryEntriesWeekly[index].invalid_400 || 0,
            validWa1: summaryEntriesWeekly[index].valid_301 || 0,
            invalidWa1: summaryEntriesWeekly[index].invalid_301 || 0,
            validWa2: summaryEntriesWeekly[index].valid_300 || 0,
            invalidWa2: summaryEntriesWeekly[index].invalid_300 || 0,
            validWa3: summaryEntriesWeekly[index].valid_302 || 0,
            invalidWa3: summaryEntriesWeekly[index].invalid_302 || 0,
            valid: summaryEntriesWeekly[index].valid || 0,
            invalid: summaryEntriesWeekly[index].invalid || 0,
            total: summaryEntriesWeekly[index].all || 0,
    ...
    for (let index = 0; index < summaryEntriesHourly.length; index++) {
        await model.insertEntriesSummarydayli({
            validMicrosite: summaryEntriesHourly[index].valid_400 || 0,
            invalidMicrosite: summaryEntriesHourly[index].invalid_400 || 0,
            validWa1: summaryEntriesHourly[index].valid_301 || 0,
            invalidWa1: summaryEntriesHourly[index].invalid_301 || 0,
            validWa2: summaryEntriesHourly[index].valid_300 || 0,
            invalidWa2: summaryEntriesHourly[index].invalid_300 || 0,
            validWa3: summaryEntriesHourly[index].valid_302 || 0,
            invalidWa3: summaryEntriesHourly[index].invalid_302 || 0,
            valid: summaryEntriesHourly[index].valid || 0,
            invalid: summaryEntriesHourly[index].invalid || 0,
            total: summaryEntriesHourly[index].all || 0,
